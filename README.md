...
```kdl
// Generated by nwg-displays on 2026-04-08 at 15:00:00. Do not edit manually.
...
options:
  -h, --help            show this help message and exit
  -m MONITORS_PATH, --monitors_path MONITORS_PATH
                        path to save the monitor.kdl file to, default: ~/.config/niri/monitor.kdl
  -n NUM_WS, --num_ws NUM_WS
                        number of Workspaces in use, default: 10 (not used by Niri)
  -v, --version         display version information
```
